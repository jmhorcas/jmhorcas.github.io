...
I am an **Associate Professor** in the area of **Programming Languages and Software Systems** at the **University of Málaga**. My research focuses on **Software Product Lines**, **variability management**, **configuration**, and the development of **software tools and open solutions** for large-scale configurable systems.
...
📖 **[PhD Thesis →]({{ '/thesis/' | relative_url }})**
